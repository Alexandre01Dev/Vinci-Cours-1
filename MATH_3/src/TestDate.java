public class TestDate{
    ...
    private static boolean estBissextile2(int annee){
        return (annee % 400 == 0) || estBissextile(annee) && (annee % 100 != 0);	// A MODIFIER
    }

    private static boolean verifieJourEtMois(int jour, int mois, int jourMax){
        return (jour <= jourMax && jour > 0) && mois <= 12 && mois > 0;
    }
      	
    private static boolean estValide(int jour, int mois, int annee){
        return ((mois % 2 != 0 && (verifieJourEtMois(jour,mois,30))) || mois % 2 == 0 && mois != 2 && verifieJourEtMois(jour,mois,31)) || (mois == 2) && (estBissextile2(annee) && verifieJourEtMois(jour,mois,29) || !estBissextile2(annee) && verifieJourEtMois(jour,mois,28));
    }
    ...
    private static boolean estAnterieure(int jour1, int mois1, int annee1, int jour2, int mois2, int annee2 ){
        return annee1 < annee2 || annee1 == annee2 && mois1 < mois2 || annee1 == annee2 && mois1 == mois2 && jour1 < jour2;	// A MODIFIER
    }
