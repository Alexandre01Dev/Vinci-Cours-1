...
public class CabinesDEssayage {
	...
	public void libererCabine(int numeroCabine) throws IllegalArgumentException, IllegalStateException{
		// TODO
		if(numeroCabine <= 0 || numeroCabine > tableOccupations.length){
			throw new IllegalArgumentException("Le Numéro de la cabine est invalide");
		}

		if(!tableOccupations[numeroCabine-1]){
			throw new IllegalStateException("La cabine n'est pas occupée");
		}
